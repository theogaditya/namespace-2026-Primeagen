...
export function Step2DetailsAI({
  ...
  // Uncomment the following function call to enable image validation
  // This will validate the image for relevance after AI analysis
...
export default function TestAutoPage() {
  const [formData, setFormData] = useState({
    subCategory: "",
    description: "",
    urgency: "LOW" as ComplaintUrgency,
    isPublic: false,
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-6 sm:p-8">
        <Step2DetailsAI
          ...
          setErrors={setErrors}
          setPhoto={setPhoto}
          onValidationStatusChange={(status) => console.log("Validation status:", status)}
