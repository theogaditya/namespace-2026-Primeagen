...
const NAV_ITEMS = [
  ...
  { name: "Municipal Management", icon: "domain", tabKey: 'municipal-management' as const },
]
      ...
      <div className="min-h-screen bg-[#f8f9fa] text-[#191c1d]" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <main className="lg:ml-64 min-h-screen flex flex-col">
          ...
          <header className="sticky top-0 z-30 bg-[#f8f9fa]/80 backdrop-blur-xl flex items-center justify-between px-6 py-3 w-full shadow-sm">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-purple-50 rounded-full">
                <span className="w-2 h-2 rounded-full bg-[#115cb9]" />
                <span className="text-xs font-bold text-[#041627] tracking-tight">STATE ADMIN</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] text-slate-500 uppercase mt-0.5">{adminData?.state || 'State'}</p>
                </div>
