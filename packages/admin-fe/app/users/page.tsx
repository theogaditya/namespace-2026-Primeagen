...
// Old implementation commented out below — see app/(pages)/agent-revamped/my-complaints/page.tsx for the revamped version.
//
// "use client"
...
export default function UsersPage() {
  redirect('/agent-revamped/my-complaints')
}
